...
/**
 * java web 页面静态化 （吴彦文 原创，赞）
 * http://blog.csdn.net/wuyanwen888/article/details/9125511
...
public class HtmlGenerator {
    ...
    Logger logger = LoggerFactory.getLogger(HtmlGenerator.class);
    ...
    /** 根据模版及参数产生静态页面 */
    public boolean createHtmlPage(String url,String htmlFileName){ //url:http://localhost:8080/yanCms/three/three?parent_id=10&id=103&type=10
        ...
        try{
            ...
            if (statusCode != 200) {
                logger.info("静态页面引擎在解析" + url + "产生静态页面" + htmlFileName + "时出错!" + statusCode);
            }else{
    ...
    public static void main(String[] args){
        ...
        h.createHtmlPage("http://localhost:8080/task/index.jsp","d:/a.html");
